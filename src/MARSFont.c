...
symbol B = {
	...
	.actions[4] = {.identity = RLINETO, .pair.x = 25, .pair.y = 12},
	.actions[5] = {.identity = RLINETO, .pair.x = -25, .pair.y = 12},
	.actions[6] = {.identity = RMOVETO, .pair.x = 25, .pair.y = -50}
};
...
symbol D = {
	...
	.actions[2] = {.identity = RLINETO, .pair.x = 25, .pair.y = -25},
	.actions[3] = {.identity = RLINETO, .pair.x = -25, .pair.y = -25},
	.actions[4] = {.identity = RMOVETO, .pair.x = 25, .pair.y = 0},
...
symbol U = {
	...
	.actions[1] = {.identity = RLINETO, .pair.x = 12, .pair.y = 15},
	.actions[2] = {.identity = RLINETO, .pair.x = 12, .pair.y = -15},
	.actions[3] = {.identity = RLINETO, .pair.x = 0, .pair.y = -35},
	.actions[4] = {.identity = RMOVETO, .pair.x = 5, .pair.y = 0}
};
